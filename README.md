# Лабораторная работа №7. Multihoming	
...
В качестве исходной сети, возьмем сеть из лабораторной работы №6 с уже настроенным Underlay и Overlay на основе eBGP. В качестве модели multihoming возьмем VXLAN MLAG
